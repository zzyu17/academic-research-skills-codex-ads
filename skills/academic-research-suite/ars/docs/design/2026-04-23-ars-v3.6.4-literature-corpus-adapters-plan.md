...
- Modify: `academic-pipeline/WORKFLOW.md`
- Modify: `academic-paper/WORKFLOW.md`
- Modify: `academic-paper-reviewer/WORKFLOW.md`
- Modify: `deep-research/WORKFLOW.md`
...
For each of `academic-pipeline/WORKFLOW.md`, `academic-paper/WORKFLOW.md`, `academic-paper-reviewer/WORKFLOW.md`, `deep-research/WORKFLOW.md`, find the version footer and bump 3.6.3 → 3.6.4.
...
```bash
cd ~/Projects/academic-research-skills
git add -A scripts/check_spec_consistency.py academic-pipeline/WORKFLOW.md academic-paper/WORKFLOW.md academic-paper-reviewer/WORKFLOW.md deep-research/WORKFLOW.md .claude/CLAUDE.md README.md README.zh-TW.md
git status
git commit -m "$(cat <<'EOF'
